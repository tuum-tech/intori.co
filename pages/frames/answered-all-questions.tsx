...
export const getServerSideProps = (async (context) => {
  const frameUrl = `${process.env.NEXTAUTH_URL}/frames/answered-all-questions`
  const imageUrl = `${process.env.NEXTAUTH_URL}/assets/templates/answered_all_questions.png`
